...
function gswv_help_menu_cb() {
    ...
    <div class="wrap">
    	...
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 20px; text-align: center;">
			...
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://gsplugins.com/product/woocommerce-variation-swatches" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://woovariation.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://woovariation.gsplugins.com/documentation" target="_blank">Documentation</a>
        ...
        <div class="gswps-admin-sidebar" style="width: 277px; float: left; margin-top: 20px; text-align: center;">
            <div class="postbox">
