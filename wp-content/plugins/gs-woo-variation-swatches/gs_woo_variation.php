 ...
 * Defining constants
 */
if( ! defined( 'GS_WOO_VERSION' ) ) define( 'GS_WOO_VERSION', '1.4.1' );
...
if ( ! function_exists('gs_wvariation_pro_link') ) {
    function gs_wvariation_pro_link( $gsVars_links ) {
        $gsVars_links[] = '<a class="gs-pro-link" href="https://gsplugins.com/product/woocommerce-variation-swatches" target="_blank">Go Pro!</a>';
        $gsVars_links[] = '<a href="https://gsplugins.com/wordpress-plugins" target="_blank">GS Plugins</a>';
        return $gsVars_links;
    }
...
if( ! class_exists( 'GS_Woo_Variation' ) ){
    ...
    class GS_Woo_Variation {
        ...
        public function load_pdf_admin_script() {
            ...
            wp_enqueue_media();
            wp_enqueue_style( 'var-admin', GS_WOO_PLUGIN_URI. '/assets/css/variation-admin.css', '', GS_WOO_VERSION );
            wp_enqueue_style( 'mail-signup','//cdn-images.mailchimp.com/embedcode/slim-081711.css', '', GS_WOO_VERSION );
        ...
        public function product_option_terms( $taxonomy, $i ) {
            ...
            if ( in_array( $taxonomy->attribute_type, array_keys( gs_get_custom_tax_types() ) ) ) {
       ...
       public function product_attribute_column( $columns, $column, $id ) {
        ...
        public function attribute_save( $term_id, $tt_id, $taxonomy ) {
            ...
            if( isset( $_POST['term_value'] ) ) {
                ...
                if( is_array( $_POST['term_value'] ) ){
                    ...
                    $term_value = $this->sanitize_text_or_array_field( $_POST['term_value'] );
                    $array_values = array_filter( $term_value );
                    ...
                    $value = $this->sanitize_text_or_array_field( $_POST['term_value'] );
                }
                                ...
                                <div class="postbox">
                                    ...
                                    <div class="inside">
                                        <table cellpadding="5" cellspacing="5" class="form-table">
                                            ...
                                            <tr>
                                                <th><?php _e( 'Attribute Style', 'gs-variation' ) ?></th>
                                                <td>
                                                    <input type="radio" name="gs_settings[attribute_style]" value="square" <?php checked( isset( $data['attribute_style'] ) && $data['attribute_style']=='squre'  ); ?> checked >Square
                                                    <input type="radio" name="gs_settings[attribute_style]" value="round" <?php checked( isset( $data['attribute_style'] ) && $data['attribute_style']=='round' ) ;?>>Round   
                                                </td>
                                            </tr>                                          
            ...
            <div class="gswvar-admin-sidebar" style="width: 277px; float: left; margin: 62px 0 0 22px; text-align: center;">
                <div class="postbox">
                    ...
                    <div class="inside centered">
                        ...
                        <p><a href="https://gsplugins.com/support" target="_blank" class="button button-primary">Get Support</a></p>
                    </div>
                </div>
                <div class="postbox">
        ...
        public function save_pdf_settings() {
            ...
            $data1= isset( $_POST['gs_settings'] ) ? $_POST['gs_settings'] : array();
            $data1 = $this->sanitize_text_or_array_field($data1);
            $data = $data1;
