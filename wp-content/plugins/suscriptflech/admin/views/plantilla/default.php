                            ...
                            <table  bgcolor="#ffffff" style="border-bottom: 2px solid #eaeaea;" border="0" cellpadding="0" cellspacing="0" width="100%">                                                               
                                ...
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        $imagen = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'imggrande');
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <a href="<?php echo get_permalink($post->ID);?>" style="background-color: #53545e;padding: 10px 15px;color: #ffffff;text-decoration: none;font-family: Arial, Verdana, sans-serif;">Leer más</a> 
                                    </td>
                                </tr>                         
                            </table>
                         </td>
                                    ...
                                    <td width="260" valign="top">
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>                                            
                                                <td>
                                                    <?php
                                                        $imagenpequena = wp_get_attachment_image_src( get_post_thumbnail_id(), 'imgpequena');
                                             ...
                                             <tr>
                                                ...
                                                <td style="text-align: justify;color: #bfc0c3;font-size: 13px;font-family: Arial, Verdana, sans-serif;">
                                                    ...
                                                    <tr>
                                                <td style="padding: 35px 0px 35px 0px">
                                                <a href="<?php the_permalink(); ?>" style="background-color: #53545e;padding: 10px 15px;color: #ffffff;text-decoration: none;font-family: Arial, Verdana, sans-serif;">Leer más</a> 
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
