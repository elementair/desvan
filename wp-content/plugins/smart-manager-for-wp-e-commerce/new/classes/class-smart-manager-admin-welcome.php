...
class Smart_Manager_Admin_Welcome {
	...
	function smart_manager_support_ticket_content() {
		...
		if ( ! method_exists( 'StoreApps_Upgrade_3_4', 'support_ticket_content' ) ) return;

		$plugin_data = get_plugin_data( self::$plugin_file );
		$license_key = get_site_option( self::$prefix.'_license_key' );

		StoreApps_Upgrade_3_4::support_ticket_content( self::$prefix, self::$sku, $plugin_data, $license_key, 'smart-manager-for-wp-e-commerce' );
	}
			...
			<div class="column col last-feature">
				<p align="right">
					<?php 
						...
						echo __( 'Questions? Need Help?', 'smart-manager-for-wp-e-commerce' ); 
					?><br>
	...
	public function about_screen() {
		...
		<div class="wrap sm-welcome about-wrap">
			...
			<div class = "col" style="margin:0 auto;">
				<br/>
				<p style="font-size:1em;"><?php echo __( 'Smart Manager is a unique, revolutionary tool that gives you the power to <b>boost your productivity by 10x</b> in managing your <b>WooCommerce</b> store by using a using a <b>familiar, single page, spreadsheet like interface</b>. ', 'smart-manager-for-wp-e-commerce' ); ?></p>
